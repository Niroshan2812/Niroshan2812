...
* 🌱 **Current Focus** Pursuing a B.S. in Software Engineering and exploring the intersection of AI and Web Technologies.
* 🛠️ **Building** Creator of [CodeCoffeeTools](https://codecoffeetools.com/), a collection of client-side utility tools for developers.
* 🧠 **Explorative** I focus on mastering logic and patterns over memorizing code snippets.
* 🔭 **Portfolio** Explore my projects at [niroshan-port.vercel.app](https://niroshan-port.vercel.app/).
* 🔍 **RE & Systems** Interested in **Reverse Engineering** and understanding low-level system internals.


### 🛠️ Tech Stack & Tools

* **Languages:** Java, JavaScript (Next.js/React), Python
* **Artificial Intelligence:**
  * Reinforcement Learning (RL)
  * LLM Fine-tuning & Optimization (GGUF, Abliteration)
